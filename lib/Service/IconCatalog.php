...
final class IconCatalog
{
	private const ICONS = [
		...
		'shield-off' => '<path d="M19.69 14a6.9 6.9 0 0 0 .31-2V5l-8-3-3.16 1.18"/><path d="M4.73 4.73 4 5v7c0 6 8 10 8 10a20.3 20.3 0 0 0 5.62-4.38"/><path d="m2 2 20 20"/>',
	...
	public static function render(string $name, ?string $extraClass = null): string
	{
		...
		$class = 'lck-icon' . ($extraClass !== null ? ' ' . htmlspecialchars($extraClass, ENT_QUOTES, 'UTF-8') : '');
		return sprintf(
